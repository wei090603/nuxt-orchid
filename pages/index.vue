...
const advertiseData = await getAdvertise({ position: 'home' });
state.advertiseList = advertiseData.data.value;

const tagData = await getHotTag();
state.tagHotList = tagData.data.value;
